import { Effector } from 'casbin/lib/cjs/effect';
import { FunctionMap, Model, PolicyOp } from 'casbin/lib/cjs/model';
import { Adapter, FilteredAdapter, Watcher, BatchAdapter, UpdatableAdapter, WatcherEx } from 'casbin/lib/cjs/persist';
import { RoleManager } from 'casbin/lib/cjs/rbac';
import { MatchingFunc } from 'casbin/lib/cjs/rbac';
/**
